...
public class PgNumericDecoderTest {
    ...
    public void testDecode() {
        ...
        try {
            ...
            assertEquals("ErrorCode:[COMMON-05], ErrorDescription:[Unsupported operation] - PostgreSQL NUMERIC value is NaN, not supported.", e.getMessage());
        }
        ...
        buf9.flip();
        assertEquals(new BigDecimal("10000000000000000000000000000000000000000"), PgNumericDecoder.decode(buf9));
